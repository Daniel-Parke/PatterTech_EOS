...
2. **A follow-up agent generalises the kernel.** After this module is in use,
   ...
   extract EVERYTHING learned from the **AutoWatt seed-pack creation**, with
...
- `C:\Users\Daniel\Documents\Coding\Github\AutoWatt\org\` : the file-based org
...
- The **AutoWatt seed pack** work itself: the process and lessons of creating
