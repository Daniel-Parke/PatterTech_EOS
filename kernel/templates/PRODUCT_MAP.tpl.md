---
summary: Product map template, the domain model, contracts, dependency graph and per-journey acceptance conditions Genesis fills
type: template
tags: [eos]
template: true
---

# {{VENTURE_NAME}} · Product map
...
| decision | ruling | recorded in |
| --- | --- | --- |
|  |  | a docs/LOCKBOOK.md ruling, or a docs/TASKS.md row |
<!-- scale: end -->
