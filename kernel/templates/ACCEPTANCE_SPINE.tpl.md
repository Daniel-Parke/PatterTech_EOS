---
summary: Acceptance spine template, the journey walk-through as a suite skeleton that starts failing and goes green journey by journey
type: template
tags: [eos]
template: true
---

# {{VENTURE_NAME}} · Acceptance spine
