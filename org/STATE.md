...
holds D1 to F. Nothing blocks the AutoWatt reseed now; D1 and D2 are
the critical path.
...
- phase: B and C done; next item D1 (AutoWatt reseed, time-critical)
...
- next_action: entry mode 2, take D1: run PB-E01 compile phases in the
  AutoWatt repo on an isolated branch, then Daniel signs the rubric
- blockers: none
