...
| Railway | Dockerised APIs, Postgres, cron and worker services | WiseWattage | AWS App Runner (proven shape in Venture A ADR-0002) | met |
| AWS eu-west-2 | Full estate when residency or contracts demand it | Venture A (ADR-0002, proposed) | n/a, the fallback itself | proposed |
