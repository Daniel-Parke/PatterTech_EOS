...
| --- | --- | --- | --- | --- | --- |
| AutoWatt | `C:\Users\Daniel\Documents\Coding\Github\AutoWatt` | L | pre-EOS on main; reseed compiled at pre-1.0.0 @ 0a2a044 on branch reseed/eos-v1 | Reseed seed-check green, awaiting Daniel's rubric sign-off; merge then Genesis | 2026-07-07 (reseed feedback, two entries folded) |
