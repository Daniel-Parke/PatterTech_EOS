...
- **Evaluation**: packs/ai-ml-llm/CHECKS.md, the reviewable criteria for this domain. The acceptance drill packs/ai-ml-llm/research/DRILL_PROPOSAL.md is frozen at benchmark/drills/ai-ml-llm.md and now carries a scenario and graders, but no cold-agent attempt has been run, so it has returned no verdict; see benchmark/drills/RESULTS.json.
...
- **Worked example**: `packs/api-integration/exemplars/invoices-api-change.md`, `packs/api-integration/exemplars/stripe-versioning.md`
- **Evaluation**: packs/api-integration/CHECKS.md, the reviewable criteria for this domain. The acceptance drill packs/api-integration/research/DRILL_PROPOSAL.md is frozen at benchmark/drills/api-integration.md and now carries a scenario and graders, but no cold-agent attempt has been run, so it has returned no verdict; see benchmark/drills/RESULTS.json.
- **Estate relevance**: AutoWatt serves three surfaces over one API and takes vendor webhooks; WiseWattage integrates Clerk and Stripe; PatterTech_App exposes a subscribe endpoint.
- **Owner**: EOS integrator
...
- **Evaluation**: packs/pattertech-house/CHECKS.md, the reviewable criteria for this domain. The acceptance drill packs/pattertech-house/research/DRILL_PROPOSAL.md is frozen at benchmark/drills/pattertech-house.md and now carries a scenario and graders, but no cold-agent attempt has been run, so it has returned no verdict; see benchmark/drills/RESULTS.json.
...
- **Estate relevance**: PatterTech_Website, AutoWatt's three surfaces, WiseWattage's dashboards and PatterStage's control plane are four different design philosophies in one estate, which is why the pack compares rather than prescribes.
- **Owner**: EOS integrator
- **Review trigger**: on-change-of:WCAG-2.2
...
- **Evaluation**: packs/agentic-development/CHECKS.md, the reviewable criteria for this domain. The acceptance drill packs/agentic-development/research/DRILL_PROPOSAL.md is frozen at benchmark/drills/agentic-development.md and now carries a scenario and graders, but no cold-agent attempt has been run, so it has returned no verdict; see benchmark/drills/RESULTS.json.
...
- **Worked example**: `packs/architecture/exemplars/billing-catalogue-boundary.md`
- **Evaluation**: packs/architecture/CHECKS.md, the reviewable criteria for this domain. The acceptance drill packs/architecture/research/DRILL_PROPOSAL.md is frozen at benchmark/drills/architecture.md and now carries a scenario and graders, but no cold-agent attempt has been run, so it has returned no verdict; see benchmark/drills/RESULTS.json.
- **Estate relevance**: AutoWatt runs one record core with three surfaces, WiseWattage a Polars pipeline behind an API, PatterStudio a monorepo with import-linter rings. All three are live architecture decisions.
- **Owner**: EOS integrator
- **Review trigger**: 2027-02
...
- **Evaluation**: packs/business-logic-modelling/CHECKS.md, the reviewable criteria for this domain. The acceptance drill packs/business-logic-modelling/research/DRILL_PROPOSAL.md is frozen at benchmark/drills/business-logic-modelling.md and now carries a scenario and graders, but no cold-agent attempt has been run, so it has returned no verdict; see benchmark/drills/RESULTS.json.
- **Estate relevance**: AutoWatt's grant and record model and WiseWattage's tariff and battery logic are the estate's two hardest domain models, both written without shared method.
- **Owner**: EOS integrator
...
- **Evaluation**: packs/business-model-pricing/CHECKS.md, the reviewable criteria for this domain. The acceptance drill packs/business-model-pricing/research/DRILL_PROPOSAL.md is frozen at benchmark/drills/business-model-pricing.md and now carries a scenario and graders, but no cold-agent attempt has been run, so it has returned no verdict; see benchmark/drills/RESULTS.json.
...
- **Evaluation**: packs/coding/CHECKS.md, the reviewable criteria for this domain. The acceptance drill packs/coding/research/DRILL_PROPOSAL.md is frozen at benchmark/drills/coding.md and now carries a scenario and graders, but no cold-agent attempt has been run, so it has returned no verdict; see benchmark/drills/RESULTS.json.
...
- **Estate relevance**: WiseWattage has real users and handles support ad hoc. AutoWatt was still in its v1 Genesis design phase at the last look, 2026-07-07, and will need support operations once it carries real users. The EOS does not track venture progress after birth, so read that as a note rather than a date.
- **Owner**: EOS integrator
...
- **Evaluation**: packs/data-analytics/CHECKS.md, the reviewable criteria for this domain. The acceptance drill packs/data-analytics/research/DRILL_PROPOSAL.md is frozen at benchmark/drills/data-analytics.md and now carries a scenario and graders, but no cold-agent attempt has been run, so it has returned no verdict; see benchmark/drills/RESULTS.json.
...
- **Evidence**: 17 rows, EV-0305, EV-0306, EV-0307, EV-0308, EV-0309, EV-0310, EV-0311, EV-0312, EV-0313, EV-0314, EV-0315, EV-0316, EV-0317, EV-0318, EV-0319, EV-0320, EV-0321
...
- **Evaluation**: packs/delivery-testing/CHECKS.md, the reviewable criteria for this domain. The acceptance drill packs/delivery-testing/research/DRILL_PROPOSAL.md is frozen at benchmark/drills/delivery-testing.md and now carries a scenario and graders, but no cold-agent attempt has been run, so it has returned no verdict; see benchmark/drills/RESULTS.json.
- **Estate relevance**: AutoWatt and WiseWattage both carry suites with drifted doubles; the test-timing ablation sets this pack's defaults from measured evidence.
- **Owner**: EOS integrator
...
- **Evaluation**: packs/devops-reliability/CHECKS.md, the reviewable criteria for this domain. The acceptance drill packs/devops-reliability/research/DRILL_PROPOSAL.md is frozen at benchmark/drills/devops-reliability.md and now carries a scenario and graders, but no cold-agent attempt has been run, so it has returned no verdict; see benchmark/drills/RESULTS.json.
- **Estate relevance**: WiseWattage runs on Railway with Postgres and cron, AutoWatt targets AWS eu-west-2, PatterTech_App runs Docker Compose locally. Production safety is protected-set material and lives here.
- **Owner**: EOS integrator
...
- **Evaluation**: packs/docs-dx/CHECKS.md, the reviewable criteria for this domain. The acceptance drill packs/docs-dx/research/DRILL_PROPOSAL.md is frozen at benchmark/drills/docs-dx.md and now carries a scenario and graders, but no cold-agent attempt has been run, so it has returned no verdict; see benchmark/drills/RESULTS.json.
...
- **Evaluation**: packs/legal-licensing/CHECKS.md, the reviewable criteria for this domain. The acceptance drill packs/legal-licensing/research/DRILL_PROPOSAL.md is frozen at benchmark/drills/legal-licensing.md and now carries a scenario and graders, but no cold-agent attempt has been run, so it has returned no verdict; see benchmark/drills/RESULTS.json.
...
- **Evaluation**: packs/marketing-growth/CHECKS.md, the reviewable criteria for this domain. The acceptance drill packs/marketing-growth/research/DRILL_PROPOSAL.md is frozen at benchmark/drills/marketing-growth.md and now carries a scenario and graders, but no cold-agent attempt has been run, so it has returned no verdict; see benchmark/drills/RESULTS.json.
...
- **Evaluation**: packs/native-client/CHECKS.md, the reviewable criteria for this domain. The acceptance drill packs/native-client/research/DRILL_PROPOSAL.md is frozen at benchmark/drills/native-client.md and now carries a scenario and graders, but no cold-agent attempt has been run, so it has returned no verdict; see benchmark/drills/RESULTS.json.
...
- **Evaluation**: packs/product-discovery/CHECKS.md, the reviewable criteria for this domain. The acceptance drill packs/product-discovery/research/DRILL_PROPOSAL.md is frozen at benchmark/drills/product-discovery.md and now carries a scenario and graders, but no cold-agent attempt has been run, so it has returned no verdict; see benchmark/drills/RESULTS.json.
- **Estate relevance**: Both AutoWatt and Guth wrote product bibles with no EOS guidance behind them, and the Website's content strategy has no owner.
- **Owner**: EOS integrator
...
- **Worked example**: `packs/security-privacy/exemplars/poisoned-integration-guide.md`
- **Evaluation**: packs/security-privacy/CHECKS.md, the reviewable criteria for this domain. The acceptance drill packs/security-privacy/research/DRILL_PROPOSAL.md is frozen at benchmark/drills/security-privacy.md and now carries a scenario and graders, but no cold-agent attempt has been run, so it has returned no verdict; see benchmark/drills/RESULTS.json.
...
- **Evaluation**: packs/writing-content/CHECKS.md, the reviewable criteria for this domain. The acceptance drill packs/writing-content/research/DRILL_PROPOSAL.md is frozen at benchmark/drills/writing-content.md and now carries a scenario and graders, but no cold-agent attempt has been run, so it has returned no verdict; see benchmark/drills/RESULTS.json.
