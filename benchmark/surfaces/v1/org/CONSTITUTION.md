---
summary: The FieldKit constitution, product doctrine and the protected organisational law
type: template
tags: [eos]
...
1. **The record is the product.** A survey saved in FieldKit is
   complete, honest and exportable. Records are append-only; a
   correction is a new version. The office can always leave with the
   data as CSV.
2. **One firm, one workflow.** FieldKit serves one contracting firm's
   site surveys, structured the way the firm already surveys. No
   speculative multi-tenancy, no general form builder.
3. **The login email is the only personal data.** It exists so the
   firm knows who recorded what, it stays out of logs, and nothing
   else about a person is stored.
...
*Adopted 2026-08-02 (Session 0). No amendments.*
