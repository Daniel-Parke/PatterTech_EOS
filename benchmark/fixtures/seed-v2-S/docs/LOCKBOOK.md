...
- Signature motif (promoted everywhere): set at first build; ruled at
  the first-build lock-in, the top open item in docs/TASKS.md
- Signature animated pieces (the sanctioned exceptions, by name): set
  at first build; ruled at the first-build lock-in, the top open item
  in docs/TASKS.md
...
- Token home: set at first build; ruled at the first-build lock-in,
  the top open item in docs/TASKS.md · Code mirror: set at first
  build; ruled at the first-build lock-in, the top open item in
  docs/TASKS.md · Styleguide route: set at first build; ruled at the
  first-build lock-in, the top open item in docs/TASKS.md
- Surface ladder: set at first build; ruled at the first-build
  lock-in, the top open item in docs/TASKS.md
- Accents: set at first build; ruled at the first-build lock-in, the
  top open item in docs/TASKS.md
...
- Build: set at first build; ruled at the first-build lock-in, the top
  open item in docs/TASKS.md
...
- Page weight: set at first build; ruled at the first-build lock-in,
  the top open item in docs/TASKS.md
