...
- The strictly smaller version, and the verdict on it: a shared
  spreadsheet was proposed. "Rejected. A spreadsheet is what we are
  escaping. The surveys need structure, sign-in and a central copy, or
  the firm keeps losing sheets."
