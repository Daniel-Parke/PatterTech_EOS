...
coordination files. The indexes are regenerated by
`check --write-index`, the views org/TASKS.md and org/STATE.md by
`task views`, and by the release playbook; hand-edits are checker
errors.
