...
`benchmark/drills/pattertech-house.md`, hashed in
...
- Read the spec: `benchmark/drills/pattertech-house.md`
- Run it: `python -m tools.eos drills --pack pattertech-house`
