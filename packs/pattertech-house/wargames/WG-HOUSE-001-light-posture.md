...
# WG-HOUSE-001: How much light does this surface carry?

## Decision question and stakes

The house treats light as evidence of a source rather than decoration,
graded into four tiers: field, conduit, bloom and radiance. This Wargame
...
budgets in `packs/pattertech-house/references/BUDGETS.md` have to be held, or
...
Assume `C. The full graded system` was selected and the outcome failed. Test this option's stated failure mechanism first: discipline: the budgets in `packs/pattertech-house/references/BUDGETS.md` have to be held, or it collapses into option D by accident.
