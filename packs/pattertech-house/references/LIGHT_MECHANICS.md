...
`packs/pattertech-house/wargames/WG-HOUSE-001-light-posture.md` and every
number is in `packs/pattertech-house/references/BUDGETS.md`.
...
`packs/pattertech-house/references/BUDGETS.md` is local calibration.
