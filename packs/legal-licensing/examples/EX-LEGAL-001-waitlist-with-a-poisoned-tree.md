...
`packs/legal-licensing/wargames/WG-LEGAL-001-copyleft-trigger.md` the
...
bucket table in `packs/legal-licensing/references/LICENCE_CLASSES.md` this is
...
decision. That is option D in WG-LEGAL-001, recorded as a choice rather
than taken silently.
...
in `packs/legal-licensing/references/ESCALATION.md`, and the correct output
...
`packs/legal-licensing/references/UK_DATA_ROUTING.md` and both complaint
