...
Against `packs/agentic-swarm/wargames/WG-SWARM-001-swarm-or-single-agent.md`:
...
Against `packs/agentic-swarm/wargames/WG-SWARM-002-cut-the-partition.md`,
...
`packs/WARGAME_INDEX.md`, `registry/CAPABILITIES.md`, `org/TASKS.md` and
...
`packs/agentic-swarm/references/PACKET_AND_RETURN.md`. Two fields did the
most work here.
