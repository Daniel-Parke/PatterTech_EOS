...
underneath it, per
`packs/writing-content/wargames/WG-WRIT-001-clarity-philosophy.md`. Not
...
`packs/writing-content/wargames/WG-WRIT-002-message-structure.md`. Ten
...
`packs/writing-content/wargames/WG-WRIT-003-voice-scope.md`. The venture
...
`packs/writing-content/wargames/WG-WRIT-004-prose-gate.md`. No readability
...
`packs/writing-content/references/I18N_MECHANICS.md`.
...
`packs/writing-content/references/ERROR_CONTRACT.md`. The machine half of the
...
- No termbase was built. Five terms is a list, not a termbase, and
  WG-WRIT-004 says reach for the heavier option only where a misread
  step causes harm.
