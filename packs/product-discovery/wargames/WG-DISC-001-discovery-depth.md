...
# WG-DISC-001: How much discovery does this decision deserve?
...
Assume `C. Outcome elicitation only` was selected and the outcome failed. Test this option's stated failure mechanism first: it settles what to aim at and nothing about whether anyone will use it or pay for it. The scoring arithmetic attached to this school is separately unsupported, see `packs/product-discovery/wargames/WG-DISC-003-choosing-between-opportunities.md`.
...
- `has_live_traffic` above the power floor in
  `packs/product-discovery/references/SAMPLE_AND_SIGNAL.md`, and the change is
...
Treat any confident claim about the right length, including this Wargame's, as a working rule.
