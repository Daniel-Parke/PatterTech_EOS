...
<a id="B2"></a>
- `B2` to [DOC-AIML-001](doctrines/DOC-AIML-001-every-eval-result-carries-the-prompt-template-identity-and-the-m.md) (binding)
<a id="B3"></a>
- `B3` to [DOC-AIML-002](doctrines/DOC-AIML-002-a-private-held-out-set-exists-and-the-tuning-path-never-reads-it.md) (binding)
<a id="B4"></a>
- `B4` to [DOC-AIML-003](doctrines/DOC-AIML-003-model-identifiers-are-pinned-to-a-version-the-provider-has-under.md) (binding)
<a id="B5"></a>
- `B5` to [DOC-AIML-004](doctrines/DOC-AIML-004-a-judge-is-validated-against-human-labels-before-its-score-decid.md) (binding)
<a id="B7"></a>
- `B7` to [DOC-AIML-005](doctrines/DOC-AIML-005-consequential-model-output-is-reviewed-by-a-person-before-it-tak.md) (binding)
<a id="D1"></a>
- `D1` to [DOC-AIML-006](doctrines/DOC-AIML-006-grade-a-sample-by-hand-before-writing-the-rubric.md) (default)
<a id="D2"></a>
- `D2` to [DOC-AIML-007](doctrines/DOC-AIML-007-report-paired-differences-with-a-stated-minimum-detectable-effec.md) (default)
<a id="D3"></a>
...
<a id="D7"></a>
- `D7` to [DOC-AIML-012](doctrines/DOC-AIML-012-order-every-prompt-stable-prefix-first-variable-suffix-last-and.md) (default)
<a id="D8"></a>
- `D8` to [DOC-AIML-013](doctrines/DOC-AIML-013-an-eval-run-is-reproducible-without-the-network.md) (default)
<a id="D9"></a>
- `D9` to [DOC-AIML-014](doctrines/DOC-AIML-014-run-a-machine-repeatable-eval-before-a-model-facing-change-ships.md) (default)
<a id="D10"></a>
- `D10` to [DOC-AIML-015](doctrines/DOC-AIML-015-score-abstention-and-report-the-abstention-rate-beside-accuracy.md) (default)
- source `preferences:001` to [DOC-AIML-016](doctrines/DOC-AIML-016-compiled-prompt-optimisation-against-hand-written-legible-contex.md) (preference)
