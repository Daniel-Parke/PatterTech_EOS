...
Wargame `packs/ai-ml-llm/wargames/WG-AIML-002-acceptance-evidence.md`. The
...
by hand. That rules option A of the Wargame in and means no model judge
is needed here: correctness is a label equality check, which is option
A of `packs/ai-ml-llm/wargames/WG-AIML-004-who-grades-the-output.md`.
...
writing JSON. Fields per `packs/ai-ml-llm/references/EVAL_REPORT.md`:
...
`packs/ai-ml-llm/references/EVAL_REPORT.md`. Not "B is better", and not "A
...
Wargame `packs/ai-ml-llm/wargames/WG-AIML-006-model-lifecycle-and-cost.md`
and `packs/ai-ml-llm/references/MODEL_MIGRATION.md`.
