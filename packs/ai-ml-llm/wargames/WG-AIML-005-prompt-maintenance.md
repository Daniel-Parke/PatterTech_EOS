...
# WG-AIML-005: How is the prompt maintained?
...
(EV-0249). See
`packs/ai-ml-llm/wargames/WG-AIML-003-knowledge-source.md`.
...
the mechanics are in `packs/ai-ml-llm/references/CONTEXT_LAYOUT.md`.
