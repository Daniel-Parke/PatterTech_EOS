...
WG-ARCH-013 rules option B, module-shaped: one deployable, one store,
...
`packs/architecture/references/boundary-tooling.md`:
...
`packs/architecture/references/architecture-description.md`, and it must
