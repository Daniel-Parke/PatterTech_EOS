...
# WG-BMP-003: how does someone try this before paying?

## Decision question and stakes

Between first contact and first payment there is a gap, and the fork is
what fills it. This Wargame covers the shape of that gap. It does not
cover what the price is, which is
`packs/business-model-pricing/wargames/WG-BMP-001-price-anchor.md`.
