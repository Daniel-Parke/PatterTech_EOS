...
Following `packs/business-model-pricing/guides/GD-BMP-001-price-anchor.md`.
...
Following `packs/business-model-pricing/guides/GD-BMP-002-charging-unit.md`.

Flat per period, one tier. Metering is rejected because the buyer cannot
forecast the counted thing, which under the guide's decision rule ends
...
Following `packs/business-model-pricing/guides/GD-BMP-003-try-before-paying.md`.
...
guide names: a number the evidence does not support.

## Step 4: retention and lifetime value

Following `packs/business-model-pricing/refs/RETENTION_AND_LTV.md`.
...
Following `packs/business-model-pricing/refs/UK_OBLIGATIONS.md`.
...
Following `packs/business-model-pricing/guides/GD-BMP-004-repricing-trigger.md`.
...
observed churn, which is why the guide holds it as a default and why the
