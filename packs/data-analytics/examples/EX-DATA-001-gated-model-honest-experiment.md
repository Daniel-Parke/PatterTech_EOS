...
`packs/data-analytics/references/PRIVACY_IN_ANALYTICS.md` answers at rung
...
Wargame `packs/data-analytics/wargames/WG-DATA-008-event-contract.md` rules
...
Wargame `packs/data-analytics/wargames/WG-DATA-005-model-shape.md` rules B:
...
Wargame
`packs/data-analytics/wargames/WG-DATA-004-quality-gate-placement.md`
...
`packs/data-analytics/references/DATA_CONTRACT.md`: schema, quality rules,
...
`packs/data-analytics/references/DATA_CONTRACT.md` calls documentation wearing
...
`packs/data-analytics/wargames/WG-DATA-006-experiment-stopping.md`.
...
`packs/data-analytics/references/EXPERIMENT_STATS.md` gives the next actions:
