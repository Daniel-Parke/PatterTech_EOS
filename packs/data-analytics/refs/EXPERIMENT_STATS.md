...
Level-three material behind binding requirements B4 and B5 and guide
`packs/data-analytics/guides/GD-DATA-003-experiment-stopping.md`. Read
...
5. If step 4 fails, you are in option D of GD-DATA-003. Say so and stop.
