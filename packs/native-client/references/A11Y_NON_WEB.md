...
Reference for PACK.md B6 and for WG-NAT-004. This is the profile
`packs/ui-ux/PACK.md` defers to when a surface has no web UI. Read it
alongside `packs/ui-ux/references/A11Y_FLOOR.md`, which owns the numeric
...
Under WG-NAT-001 option C, the framework draws its own widgets, so
