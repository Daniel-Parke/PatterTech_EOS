...
# WG-AGENT-003: Should this be a subagent at all?

## Decision question and stakes

Delegation is the most over-used move in agent design. It looks like
modularity and behaves like distributed systems. This Wargame is the gate
before the topology Wargame: it asks whether a second agent should exist,
