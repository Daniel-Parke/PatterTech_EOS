...
Ruled with GD-UIUX-001 before any pixel work, and recorded in a
...
GD-UIUX-002 default taken: headless primitives with an own visual
...
GD-UIUX-004 default taken: one source file in the community format,
...
GD-UIUX-003 option C for both, since both carry custom interactive
...
in GD-UIUX-001 and would be the harder case for the states contract.
