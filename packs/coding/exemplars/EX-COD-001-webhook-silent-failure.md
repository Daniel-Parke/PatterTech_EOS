...
Guide `packs/coding/guides/GD-COD-001-oracle-strategy.md`. The code has
...
Guide `packs/coding/guides/GD-COD-004-pin-then-change.md` gives the
...
`packs/coding/refs/ORACLES.md`.

## Step 4: commit two, the failing test

Before deciding what the fix looks like, decide what callers may
distinguish. Guide
`packs/coding/guides/GD-COD-003-failure-mode-contract.md` rules option C
...
outcomes listed in `packs/coding/refs/ERROR_PATH.md`.
