...
# WG-SUPPORT-003: Who declares a customer-visible incident, and on what signal?
...
This Wargame exists to force the choice and record it, rather than to
...
`packs/support-operations/references/SEVERITY_AND_DECLARATION.md` and the
