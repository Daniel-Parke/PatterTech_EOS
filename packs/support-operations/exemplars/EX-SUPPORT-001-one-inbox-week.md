...
Under `packs/support-operations/guides/GD-SUPPORT-001-triage-pattern.md`
...
`packs/support-operations/refs/SEVERITY_AND_DECLARATION.md`.
...
- The three reports with no reproduction detail go to `needs-info` with
  ...
  `packs/support-operations/guides/GD-SUPPORT-002-close-policy.md`. They
...
`packs/support-operations/refs/INCIDENT_COMMS.md`).
...
`packs/support-operations/refs/SYNTHESIS_PASS.md`. Written before any
