...
display_name: Testing and Delivery Assurance
...
<a id="B1"></a>
- `B1` to [DOC-COD-001](../coding/doctrines/DOC-COD-001-the-oracle-that-judges-a-change-is-authored-independently-of.md) (binding)
<a id="B2"></a>
- `B2` to [DOC-DEL-001](doctrines/DOC-DEL-001-a-check-is-never-weakened-to-make-it-pass.md) (binding)
<a id="B3"></a>
- `B3` to [DOC-DEL-002](doctrines/DOC-DEL-002-every-double-standing-in-for-a-dependency-outside-the.md) (binding)
<a id="B4"></a>
- `B4` to [DOC-DEL-003](doctrines/DOC-DEL-003-flake-is-a-named-state-with-an-owner-never-hidden-behind.md) (binding)
<a id="B5"></a>
- `B5` to [DOC-DEL-004](doctrines/DOC-DEL-004-a-check-named-as-a-gate-can-actually-fail-and-states-its.md) (binding)
<a id="B6"></a>
- `B6` to [DOC-DEL-005](doctrines/DOC-DEL-005-whatever-selection-is-in-force-every-test-runs-against-every.md) (binding)
...
- source `defaults:004` to [DOC-DEL-009](doctrines/DOC-DEL-009-doubles-for-something-inside-the-repository-get-a-contract.md) (default)
...
- source `defaults:007` to [DOC-DEL-012](doctrines/DOC-DEL-012-test-selection-from-the-diff-and-the-import-graph-pre-merge.md) (default)
- source `defaults:008` to [DOC-DEL-013](doctrines/DOC-DEL-013-property-tests-are-seeded-and-replayable-in-ci.md) (default)
- source `defaults:009` to [DOC-DEL-014](doctrines/DOC-DEL-014-contract-verification-gates-deploys-for-services-we-own-and.md) (default)
- source `preferences:001` to [DOC-DEL-015](doctrines/DOC-DEL-015-assert-what-a-user-of-the-interface-can-see-over-internals.md) (preference)
- source `preferences:002` to [DOC-DEL-016](doctrines/DOC-DEL-016-optimise-for-confidence-per-test-rather-than-layer-ratios-ev.md) (preference)
- source `preferences:003` to [DOC-DEL-017](doctrines/DOC-DEL-017-where-a-published-schema-exists-generate-conformance-and.md) (preference)
...
| Fork | Wargame |
| --- | --- |
| Which double stands in for this port | `packs/delivery-testing/wargames/WG-DEL-005-test-doubles.md` |
| Where the oracle comes from, and who writes it | `packs/delivery-testing/wargames/WG-DEL-006-oracle-independence.md` |
| What has to exist before work fans out, and when checks get written | `packs/delivery-testing/wargames/WG-DEL-007-test-timing.md` |
...
`packs/delivery-testing/references/CONTRACT_SUITES.md`, flake sources and the
quarantine record in
`packs/delivery-testing/references/FLAKE_AND_DETERMINISM.md`, and what
coverage, mutation score, property tests and selection are each worth
in `packs/delivery-testing/references/QUALITY_SIGNALS.md`. A worked run is
`packs/delivery-testing/examples/EX-DEL-001-drifted-fake-and-a-lying-suite.md`.
