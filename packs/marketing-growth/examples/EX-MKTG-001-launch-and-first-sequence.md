...
Ruled with `packs/marketing-growth/wargames/WG-MKTG-001-growth-philosophy.md`
...
**Ownership (D6, Wargame WG-MKTG-004, option A).** A manifest names a
...
Ruled with `packs/marketing-growth/wargames/WG-MKTG-002-consent-route.md`.
Route A, explicit opt-in, at an unticked box on the signup form.

Each record carries the fields in
`packs/marketing-growth/references/CONSENT_RECORD.md`: address,
...
Ruled with `packs/marketing-growth/wargames/WG-MKTG-003-effect-measurement.md`.
