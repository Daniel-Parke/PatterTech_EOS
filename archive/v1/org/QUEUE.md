...
complete bar REL's manual close; AutoWatt is signed and in Genesis.
...
- When fake against mock against real, per port; verified-fakes
  ...
  AutoWatt's ADR-0003 as the first argued ruling. One delivery
  DOCTRINE line citing it.
- Hold until AutoWatt's W1 foundation orders are moving (Daniel's
...
- Ports at every vendor and IO seam; the domain never imports adapters;
  ...
  wargame; decided when argued. AutoWatt ADR-0003 is the worked
  material.
- Hold as G1.
...
- GUIDE. The all-in-one field guide (GUIDE.md): framework, AutoWatt
...
- D1. AutoWatt reseed: compiled S-0008, rubric signed by Daniel and
